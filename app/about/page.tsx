...
export default function About() {
  ...
  return (
    <div className="relative w-full bg-black text-white overflow-x-hidden scroll-smooth">
        ...
        <nav className="max-w-7xl mx-auto px-4 md:px-8 py-4 flex items-center justify-between">
          ...
          <div className="flex gap-6 md:gap-8 items-center">
            <button
              ...
              className="text-white/80 hover:text-[#00f0ff] transition-colors text-sm md:text-base"
            >
              How It Works
            </button>
            <button
      ...
      {/* WHY NOW SECTION */}
      <section id="why-now" className="relative py-28 px-4 md:px-8 bg-gradient-to-b from-black via-gray-900 to-black">
        <div className="max-w-6xl mx-auto fade-on-scroll opacity-0">
          <h2 className="text-5xl md:text-6xl lg:text-7xl font-extrabold mb-16 text-center tracking-tight leading-tight">
            <DecryptedText
              text="Why Now?"
      ...
      {/* ROADMAP SECTION */}
      <section id="roadmap" className="relative py-28 px-4 md:px-8 bg-black">
        <div className="max-w-6xl mx-auto fade-on-scroll opacity-0">
      ...
      <section className="relative py-32 md:py-40 px-4 md:px-8 bg-gradient-to-t from-black via-gray-900 to-black">
        <div className="max-w-4xl mx-auto text-center fade-on-scroll opacity-0">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button
              size="lg"
              onClick={() => window.open("https://t.me/zerolag", "_blank")}
            ...
            <Button
              size="lg"
              variant="outline"
              onClick={() => window.open("https://docs.zerolag.trade", "_blank")}
      ...
      <footer className="relative py-10 px-4 bg-black border-t border-white/10">
        <div className="max-w-6xl mx-auto text-center">
          <p className="text-base text-white/50">Coming Soon</p>
        </div>
      </footer>
    </div>
  );
